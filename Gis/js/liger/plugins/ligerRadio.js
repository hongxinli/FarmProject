...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerRadio", arguments);
    };

    $.fn.ligerGetRadioManager = function ()
    {
        return $.liger.run.call(this, "ligerGetRadioManager", arguments);
    };
    ...
    $.liger.controls.Radio = function (element, options)
    {
        $.liger.controls.Radio.base.constructor.call(this, element, options);
    };
    $.liger.controls.Radio.ligerExtend($.liger.controls.Input, {
        __getType: function ()
        {
            return 'Radio';
        },
