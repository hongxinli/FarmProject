...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerCheckBoxList", arguments);
    }; 
    ...
    $.liger.controls.CheckBoxList = function (element, options)
    {
        $.liger.controls.CheckBoxList.base.constructor.call(this, element, options);
    };
    $.liger.controls.CheckBoxList.ligerExtend($.liger.controls.Input, {
        __getType: function ()
        {
            return 'CheckBoxList';
        },
        ...
        _init: function ()
        {
            $.liger.controls.CheckBoxList.base._init.call(this); 
        },
        _render: function ()
        {
