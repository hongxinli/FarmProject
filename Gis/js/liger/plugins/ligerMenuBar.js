...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerMenuBar", arguments);
    };
    $.fn.ligerGetMenuBarManager = function ()
    {
        return $.liger.run.call(this, "ligerGetMenuBarManager", arguments);
    };
    ...
    $.liger.controls.MenuBar = function (element, options)
    {
        $.liger.controls.MenuBar.base.constructor.call(this, element, options);
    };
    $.liger.controls.MenuBar.ligerExtend($.liger.core.UIComponent, {
        __getType: function ()
        {
            return 'MenuBar';
        },
