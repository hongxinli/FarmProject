...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerPopupEdit", arguments);
    };

    $.fn.ligerGetPopupEditManager = function ()
    {
        return $.liger.run.call(this, "ligerGetPopupEditManager", arguments);
    };
    ...
    $.liger.controls.PopupEdit = function (element, options)
    {
        $.liger.controls.PopupEdit.base.constructor.call(this, element, options);
    };
    $.liger.controls.PopupEdit.ligerExtend($.liger.controls.Input, {
        __getType: function ()
        {
            return 'PopupEdit';
        },
        ...
        _init: function ()
        {
            $.liger.controls.PopupEdit.base._init.call(this);
        },
        _render: function ()
        {
        ...
        _setGrid: function (value)
        {
            ...
            this.bind('buttonClick', function ()
            {
                if (!g.popupFn)
                {
                    ...
                    g.popupFn = $.liger.getPopupFn(options);
                }
                g.popupFn();
            });
        }
        ...
        function show()
        {
            ...
            if (p.condition)
            {
                ...
                $("div", containerBtn1).ligerButton({
                    ...
                    click: function ()
                    {
                        var rules = $.liger.getConditions(conditionPanel);
                        grid.setParm('condition', $.liger.toJSON(rules));
                        grid.reload();
                    }
                });
            }
