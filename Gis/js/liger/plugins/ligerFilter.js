...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerFilter", arguments);
    };

    $.fn.ligerGetFilterManager = function ()
    {
        return $.liger.run.call(this, "ligerGetFilterManager", arguments);
    };
    ...
    //过滤器组件
    $.liger.controls.Filter = function (element, options)
    {
        $.liger.controls.Filter.base.constructor.call(this, element, options);
    };

    $.liger.controls.Filter.ligerExtend($.liger.core.UIComponent, {
        __getType: function ()
        {
            return 'Filter'
        },
        ...
        _init: function ()
        {
            $.liger.controls.Filter.base._init.call(this);
        },
        _render: function ()
        {
