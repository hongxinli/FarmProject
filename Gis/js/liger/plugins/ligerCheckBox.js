...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerCheckBox", arguments);
    };
    $.fn.ligerGetCheckBoxManager = function ()
    {
        return $.liger.run.call(this, "ligerGetCheckBoxManager", arguments);
    };
    $.ligerDefaults.CheckBox = { disabled: false };

    $.ligerMethos.CheckBox = {};

    $.liger.controls.CheckBox = function (element, options)
    {
        $.liger.controls.CheckBox.base.constructor.call(this, element, options);
    };
    $.liger.controls.CheckBox.ligerExtend($.liger.controls.Input, {
        __getType: function ()
        {
            return 'CheckBox';
        },
