...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerRadioList", arguments);
    }; 
    ...
    $.liger.controls.RadioList = function (element, options)
    {
        $.liger.controls.RadioList.base.constructor.call(this, element, options);
    };
    $.liger.controls.RadioList.ligerExtend($.liger.controls.Input, {
        __getType: function ()
        {
            return 'RadioList';
        },
        ...
        _init: function ()
        {
            $.liger.controls.RadioList.base._init.call(this);
        },
        _render: function ()
        {
        ...
        {
           //禁用样式(value=true为全部，值为id设置单个不可用)
           if (value)
            {
                if (value.toString() == "true") {
                   ...
                   $("input:radio[value="+value+"]", this.radioList).addClass('l-radiolist-disabled').attr("disabled", true);
                }
            } else
            {
