...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerResizable", arguments,
        {
            idAttrName: 'ligerresizableid', hasElement: false, propertyToElemnt: 'target'
        });
    };

    $.fn.ligerGetResizableManager = function ()
    {
        return $.liger.run.call(this, "ligerGetResizableManager", arguments,
        {
            idAttrName: 'ligerresizableid', hasElement: false, propertyToElemnt: 'target'
        });
    };
    ...
    $.liger.controls.Resizable = function (options)
    {
        $.liger.controls.Resizable.base.constructor.call(this, null, options);
    };

    $.liger.controls.Resizable.ligerExtend($.liger.core.UIComponent, {
        __getType: function ()
        {
            return 'Resizable';
        },
        ...
        _render: function ()
        {
            ...
            g.target.mousemove(function (e)
            {
                ...
                if (p.target.ligerdragid)
                {
                    var drag = $.liger.get(p.target.ligerdragid);
                    if (drag && g.dir)
                    {
        ...
        _rendered: function ()
        {
            this.options.target.ligerresizableid = this.id;
        },
        _getDir: function (e)
        {
            var g = this, p = this.options;
