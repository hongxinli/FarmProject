...
(function ($)
{
    ...
    {
        return $.liger.run.call(this, "ligerTextBox", arguments);
    };

    $.fn.ligerGetTextBoxManager = function ()
    {
        return $.liger.run.call(this, "ligerGetTextBoxManager", arguments);
    };
    ...
    $.liger.controls.TextBox = function (element, options)
    {
        $.liger.controls.TextBox.base.constructor.call(this, element, options);
    };

    $.liger.controls.TextBox.ligerExtend($.liger.controls.Input, {
        __getType: function ()
        {
            return 'TextBox'
        },
        ...
        _init: function ()
        {
            $.liger.controls.TextBox.base._init.call(this);
