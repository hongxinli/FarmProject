...
(function ($) {
    $.fn.ligerAccordion = function (options) {
        return $.liger.run.call(this, "ligerAccordion", arguments);
    };
    ...
    $.liger.controls.Accordion = function (element, options) {
        $.liger.controls.Accordion.base.constructor.call(this, element, options);
    };
    $.liger.controls.Accordion.ligerExtend($.liger.core.UIComponent, {
        __getType: function () {
            return 'Accordion';
        },
        __idPrev: function () {
        ...
        _render: function () {
            ...
            $("> div", g.accordion).each(function (i, box) {
                ...
                if ($(box).attr("title")) {
                    ...
                    if ($(box).attr("iconcss")) {
                        ...
                        iconbox = '<span class="l-accordion-default-icon"></span>';
                    }
            ...
            $(">.l-accordion-header", g.accordion).click(function () {
                ...
                if (g.trigger("click", [this]) == false) return;
        ...
        //set all accordion show
        setShowAll: function () {
            var g = this, p = this.options;
            g.accordion = $(g.element);
            g.accordion.header = $(".l-accordion-header", g.accordion);
            var accordionCount = g.accordion.header.length;
            g.accordion.header.each(function (i, box) {
                if ($(this).css("display") == "none") {
                    $(this).show();
                } else {
                    $(this).next(".l-accordion-content").height($(this).next(".l-accordion-content").height() - (accordionCount - 1) * 24)
                }
            })
        },
        //set a accordion show,other accordion hidden
        setShow: function (selectedIndex) {
            ...
            var accordionCount = g.accordion.header.length;
            g.accordion.header.each(function (i, box) {
                if (i == selectedIndex && selectedIndex <= g.accordion.header.length - 1) {
                    $(this).show();
                    var togglebtn = $(".l-accordion-toggle:first", this);
                    if (togglebtn.hasClass("l-accordion-toggle-close")) {
        ...
        //set a accordion expand
        setExpand: function (selectedIndex) {
            var g = this, p = this.options;
            if (!selectedIndex || typeof (selectedIndex) != 'number') return false;
            g.accordion = $(g.element);
            $(".l-accordion-header", g.accordion).each(function (i, box) {
                if (i == selectedIndex && selectedIndex <= $(".l-accordion-header", g.accordion).length - 1) {
                    var togglebtn = $(".l-accordion-toggle:first", this);
                    if (togglebtn.hasClass("l-accordion-toggle-close")) {
                        togglebtn.removeClass("l-accordion-toggle-close")
                    .removeClass("l-accordion-toggle-close-over l-accordion-toggle-open-over")
