...
(function ($) {
    ...
    $.fn.ligerListBox = function (options) {
        return $.liger.run.call(this, "ligerListBox", arguments);
    };
    ...
    $.liger.controls.ListBox = function (element, options) {
        $.liger.controls.ListBox.base.constructor.call(this, element, options);
    };
    $.liger.controls.ListBox.ligerExtend($.liger.controls.Input, {
        __getType: function () {
            return 'ListBox';
        },
        ...
        _init: function () {
            $.liger.controls.ListBox.base._init.call(this);
        },
        _render: function () {
        ...
        refresh: function () {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (!p.columns) {
                    out.push("<tr " + valueIndexStr + " class='l-listbox-row'>");
                    ...
                    // 新增cancel
                    out.push("<td align='left'>" + itemHtml + "</td>");
                    p.isCancel && out.push("<td align='right' style='width:18px;' ><div class='l-listbox-cancel'></div></td>");
                    out.push("</tr>");
                } else {
            ...
            //新增cancel时间处理
            p.isCancel&&$(".l-listbox-row").hover(function () { $(this).find(".l-listbox-cancel").show(); }, function () { $(this).find(".l-listbox-cancel").hide(); })
            p.isCancel && $(".l-listbox-cancel").bind("click", function () {
                var selecteds = g.getSelectedItems();
                if (!selecteds || !selecteds.length) return;
                g.removeItems(selecteds);
