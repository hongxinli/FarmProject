<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainIndex.aspx.cs" Inherits="Web.Frame.MainIndex" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
                    ...
                    try {
                        ...
                        for (var i = 0; i < json.Menu.length; i++) {
                            ...
                            if (menu.PARENTID == '0') {
                                if (j == 0) {
                                    css = "sel";
                                    GetSeedMenu(this, menu.MODULEID, menu.MODULENAME);
                                } else {
                                    css = "removesel";
                                }
                                $("#menutab").append("<div class=\"" + css + "\" onclick=\"GetSeedMenu(this,'" + menu.MODULEID + "','" + menu.MODULENAME + "')\">" + menu.MODULENAME + "</div>");
                                j++;
                            }
                        }
                    } catch (e) {
        ...
        //子菜单
        function GetSeedMenu(e, MODULEID, MODULENAME) {
            ...
            var parm = 'action=MenuChildren&parentId=' + MODULEID;
            getAjax('Frame.ashx', parm, function (rs) {
                $("#htmlMenuPanel").append(rs);
                treeAttrCss();
            });
        }
    </script>
        ...
        <div id="Container">
            <div id="Header">
                ...
                <div id="Headermenu">
                    <table style="padding: 0px; margin: 0px; height: 70px;" cellpadding="0" cellspacing="0">
                        <tr valign="bottom">
                            <%--Top菜单--%>
                            <td id="menutab" style="vertical-algin: bottom;"></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div id="MainContent">
                <div class="navigation" id="navigation" style="padding-top: 1px;">
                    ...
                    <div id="sidebarTree">
                        <ul class="strTree" id="htmlMenuPanel">
                        </ul>
                    </div>
                </div>
                <div id="Content">
