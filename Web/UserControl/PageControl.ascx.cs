...
namespace Web.UserControl
{
    public partial class PageControl : System.Web.UI.UserControl
    {
        ...
        protected void hlkPrev_Click(object sender, EventArgs e)
        {
            ...
            this.txt_JumpNum.Value = (PageIndex).ToString();
            pager_PageChanged(sender, e);
            PageChecking();
        }
        /// <summary>
        ...
        protected void hlkLast_Click(object sender, EventArgs e)
        {
            ...
            this.txt_JumpNum.Value = lblPageCount.Text;
            pager_PageChanged(sender, e);
            PageChecking();
        }

        protected void btn_JumpClick(object sender, EventArgs e)
        {
            string str = txt_JumpNum.Value.Trim();
            if (!string.IsNullOrEmpty(str) && IsIntNum(str))
            {
