<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PageControl.ascx.cs" Inherits="Web.UserControl.PageControl" %>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    ...
                    <td>&nbsp;
                        <asp:LinkButton ID="hlkFirst" title="首页" runat="server" OnClick="hlkFirst_Click">
                        <span id="spfirst" class="first">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        </asp:LinkButton>
                    </td>
                    <td>&nbsp;
                        <asp:LinkButton ID="hlkPrev" title="上页" runat="server" OnClick="hlkPrev_Click"> 
                    ...
                    <td>&nbsp;
                        <asp:LinkButton ID="hlkNext" title="下页" runat="server" OnClick="hlkNext_Click">
                         <span id="spnext" class="next" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        </asp:LinkButton>
                    </td>
                    <td>&nbsp;
                        <asp:LinkButton ID="hlkLast" title="尾页" runat="server" OnClick="hlkLast_Click">
                    ...
                    <td>
                        <input type="text" id="txt_JumpNum" runat="server" style="width: 20px;" />
                        <asp:LinkButton CssClass="button green" title="跳转" OnClick="btn_JumpClick" runat="server">跳转</asp:LinkButton>
                    </td>
                    <td>
                        <div class="pagination-btn-separator" />
                    </td>
