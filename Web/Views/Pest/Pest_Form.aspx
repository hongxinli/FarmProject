<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pest_Form.aspx.cs" Inherits="Web.Views.Pest.Pest_Form" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        KindEditor.ready(function (K) {
            ...
            editor.html($("#PestContent").val());
        })

        function setHtml() {
            $("#PestContent").val(editor.html());
        }
        //返回
        function back() {
            var url = "/Views/Pest/Pest_List.aspx?r=" + Math.random();
            Urlhref(url);
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            ...
            <tr>
                <th class="auto-style1">病虫害名称:
                </th>
                <td class="auto-style1">
                    <input id="PestName" runat="server" type="text" class="txt" datacol="yes"
                        err="病虫害名称" checkexpession="NotNull" style="width: 800px" />
                </td>
            </tr>           
            <tr>
                <th class="auto-style1">病虫害描述:
                </th>
                <td class="auto-style1">
                    <textarea name="Content" id="Content" style="width: 800px; height: 400px;"></textarea>
                    <input type="hidden" id="PestContent" runat="server" />
                </td>
            </tr>
        </table>
        <div class="frmbottom">
