<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StepInfo_Index.aspx.cs" Inherits="Web.Base.SysStep.StepInfo_Index" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            iframeresize();
            Loading(true);
            $("#target_right").attr("src", "StepInfo_List.aspx");
            $("#target_left").attr("src", "StepInfo_Left.aspx");
        })
        /**自应高度**/
