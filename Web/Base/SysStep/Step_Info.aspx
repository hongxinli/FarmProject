<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Step_Info.aspx.cs" Inherits="Web.Base.SysStep.Step_Info" %>
        ...
        <div class="div-frm" style="height: 275px;">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    ...
                    <td colspan="3">
                        <input id="StepName" runat="server" type="text" class="txt" datacol="yes" err="步骤名称"
                            checkexpession="NotNull" style="width: 450px;" />
                    </td>
                </tr>
                <tr>
                    <th>创建用户:
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <textarea readonly="readonly" disabled="disabled" id="StepDesc" class="txtRemark" runat="server" style="width: 450px; height: 120px;"></textarea>
                    </td>
                </tr>
            </table>
            <%--所属单位--%>
