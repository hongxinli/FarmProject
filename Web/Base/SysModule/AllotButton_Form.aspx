<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllotButton_Form.aspx.cs" Inherits="Web.Base.SysModule.AllotButton_Form" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $("#allButton div").dblclick(function () {
                ...
                if (IsExist == true) {
                    ...
                    getAjax('SysModule.ashx', parm, function (rs) {
                        if (parseInt(rs) > 0) {
        ...
        function removeButton(id) {
            var delparm = 'action=removeButton&key=' + id;
            DeleteData('SysModule.ashx', delparm)
        }
