<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateUserPwd.aspx.cs" Inherits="Web.Base.SysUser.UpdateUserPwd" %>
    ...
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            <tr>
                ...
                <td>
                    <input type="text" disabled="disabled" id="txtUserName" runat="server" class="txt" style="width: 200px;" />
                </td>
            </tr>
            <tr>
                <th>旧密码：
