<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_Form.aspx.cs" Inherits="Web.Base.SysUser.UserInfo_Form" %>
        ...
        <div class="div-frm" style="height: 275px;">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    ...
                    <td>
                        <input id="UserId" runat="server" type="text" class="txt" datacol="yes" err="登录账号"
                            checkexpession="NotNull" style="width: 200px" />
                    </td>
                    <th>用户姓名:
                    </th>
                    <td>
                        <input id="UserName" runat="server" type="text" class="txt" datacol="yes" err="用户姓名"
                            checkexpession="NotNull" style="width: 200px" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="UserPwd" runat="server" type="text" class="txt" datacol="yes" err="登录密码"
                            checkexpession="NotNull" style="width: 200px" /><br /><span style="color:red;">初始化密码：0000</span>
                    </td>
                    <th>联系电话:
                    </th>
                    <td>
                        <input id="Phone" runat="server" type="text" class="txt" datacol="yes" err="联系电话"
                            style="width: 200px" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="IsAdmin" class="select" runat="server" style="width: 206px">
                ...
                <tr>
                    ...
                    <td>
                        <input id="Am" runat="server" type="text" class="txt" datacol="yes" err="AM鸽子"
                            style="width: 200px" />
                    </td>
                    <th>系统样式:
                    </th>
                    <td>
                        <select id="Theme" class="select" runat="server" style="width: 206px">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <textarea id="Remarks" class="txtRemark" runat="server" style="width: 552px; height: 83px;"></textarea>
                    </td>
                </tr>
            </table>
            <%--所属单位--%>
